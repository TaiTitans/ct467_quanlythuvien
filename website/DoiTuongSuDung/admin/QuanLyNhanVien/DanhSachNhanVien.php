...
<body>
    ...
    <main>
        <div>
            <a href="../QuanLyNhanVien/ThucHienThemNhanVien.php">Thêm Nhân Viên</a>
            <a href="../../../../Librarian_Project/code/dist/trangchu.html">Trang chủ</a>
            <table>
                <tr class="TieuDeBang">
                ...
                $TTnhanvien = infNhanVien();
                while ($row = mysqli_fetch_array($TTnhanvien)) {
                    echo '<tr>
                                    <td>' . $row['UserID'] . '</td>
                                    <td>' . $row['hoTen'] . '</td>
                                    <td>' . $row['gioiTinh'] . '</td>
