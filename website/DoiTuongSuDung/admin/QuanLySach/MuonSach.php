              ...
              <form action="ThucHienLuuThongTinMuonSach.php?MSNV=<?php echo $msnv; ?>&idSach=<?php echo $idSach; ?>" method="post" enctype="application/x-www-form-urlencoded">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input disabled type="text" value='<?php echo $ttSach['gia'];?>' name="gia" id="IDdocGia" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="">
                  </div>
                  <div class="col-span-6 sm:col-span-3">
