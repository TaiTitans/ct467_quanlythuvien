      ...
      <form class="py-4 px-6" action="ThucHienCapNhatSach.php?IDsach=<?php echo $IDsach; ?>" method="post" name="BieuMauThemSach" enctype="application/x-www-form-urlencoded" onsubmit="return BieuMauThemSach()">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="SoLuongSach" value=" <?php mysqli_next_result($connect);
                                                        echo ID_SoLuongSach($TTsach['idSach']); ?>">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="message" rows="4" name="MoTa"><?php echo $TTsach['MoTa']; ?></textarea>
        </div>
